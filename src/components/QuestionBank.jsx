...
export default function QuestionBank() {
  ...
  const seedDemo = async () => {
    ...
    const demos = [
      { category: "Science", type: "multiple-choice", question: "Which planet is known as the Red Planet?", options: ["Earth", "Mars", "Jupiter", "Saturn"], answer: "Mars", reference: "Astronomy" },
      { category: "Mathematics", type: "multiple-choice", question: "What is the value of Pi to two decimal places?", options: ["3.12", "3.14", "3.16", "3.18"], answer: "3.14", reference: "Geometry" },
      { category: "Technology", type: "short-answer", question: "What does HTML stand for?", options: [], answer: "HyperText Markup Language", reference: "Web Development" },
      { category: "History", type: "multiple-choice", question: "In which year did the Titanic sink?", options: ["1912", "1905", "1898", "1923"], answer: "1912", reference: "20th Century" },
      { category: "Geography", type: "multiple-choice", question: "What is the largest ocean?", options: ["Atlantic", "Indian", "Pacific", "Arctic"], answer: "Pacific Ocean", reference: "Earth Science" },
    ]
    try {
    ...
    <div>
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex gap-2">
          <button onClick={seedDemo} className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-slate-800/60 border border-slate-700/50 text-slate-400 text-sm hover:text-slate-200 transition-all cursor-pointer">
            <RefreshCw className="w-4 h-4" /> Seed Demo
          </button>
          <button onClick={loadQuestions} className="p-2 rounded-lg bg-slate-800/60 border border-slate-700/50 text-slate-400 hover:text-slate-200 transition-all cursor-pointer">
      ...
      {loading ? (
        ...
        <div className="text-center py-12 text-slate-500">
          ...
          <p className="text-sm">Add questions manually or seed demo questions</p>
        </div>
      ) : (
